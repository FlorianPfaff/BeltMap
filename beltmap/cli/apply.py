...
OPTION_SPECS: tuple[tuple[str, str, str, tuple[tuple[str, ...], ...], str, str | None], ...] = (
    ...
    ("map_frame_median_offset_correction", "MAP_FRAME_MEDIAN_OFFSET_CORRECTION", "bool", (("map_frame_median_offset_correction",), ("map", "frame_median_offset_correction")), "Normalize sampled frames by their median brightness before belt-map accumulation.", None),
