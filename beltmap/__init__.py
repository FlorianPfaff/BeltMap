...
# Import for side effect: reject Python and NumPy booleans where revolution-split
# APIs require frame, revolution, or count integers.
from . import revolution_split_boolean_patch as _revolution_split_boolean_patch  # noqa: F401,E402
