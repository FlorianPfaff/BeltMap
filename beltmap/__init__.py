...
# Import for side effect: keep science-export velocity values in pixels/second
# only when a valid frame rate is available for conversion.
from . import flux_velocity_units_patch as _flux_velocity_units_patch  # noqa: F401,E402
